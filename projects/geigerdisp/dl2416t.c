/*!
    ...
    \addtogroup PROJECTS_GEIGERDISP_DL2416T
    @{
*/
...
void dl2416tInit(void)
{
    ...
    PIN_OUTPUT(DL_CE1_PIN);  PIN_LOW(DL_CE1_PIN);
    PIN_OUTPUT(DL_CE2_PIN);  PIN_LOW(DL_CE2_PIN);
    PIN_OUTPUT(DL_CLR_PIN);  PIN_HIGH(DL_CLR_PIN);
    PIN_OUTPUT(DL_CUE_PIN);  PIN_LOW(DL_CUE_PIN); // no cursor
    PIN_OUTPUT(DL_CU_PIN);   PIN_HIGH(DL_CU_PIN);
}
